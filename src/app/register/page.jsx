  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-[900px] bg-white rounded-sm shadow-2xl p-6 md:p-10 z-10 font-sans text-[#111111]">
        ...
        <h2 className="text-3xl font-bold mb-6 border-b border-gray-100 pb-4">Sign Up</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-start mt-6">
          ...
          <form onSubmit={(e) => e.preventDefault()} className="space-y-4">
            <div>
              <input type="text" placeholder="Username*" className="w-full px-4 py-3 bg-[#EEEEEE] text-gray-800 rounded-sm text-sm focus:outline-none" required />
            </div>
            <div>
              <input type="email" placeholder="Email Address*" className="w-full px-4 py-3 bg-[#EEEEEE] text-gray-800 rounded-sm text-sm focus:outline-none" required />
            </div>
            <div>
            ...
            <div className="flex items-center gap-2 pt-2">
              <input type="checkbox" id="terms" className="w-4 h-4 rounded-sm border-gray-300 text-[#EF3737] focus:ring-[#EF3737] cursor-pointer" required />
              <label htmlFor="terms" className="text-gray-600 text-sm font-medium cursor-pointer select-none">
                I Agree with <span className="text-[#EF3737] hover:underline cursor-pointer">Terms and Conditions</span>
              </label>
            </div>

            <button type="submit" className="w-full md:w-auto px-10 py-3 bg-[#EF3737] text-white font-bold rounded-sm hover:bg-[#d62f2f] uppercase text-sm tracking-wider transition-colors mt-2">
              Sign Up
            </button>
          </form>
        ...
        <div className="mt-8 pt-6 border-t border-gray-100 text-center text-sm font-medium">
          <div className="text-gray-600">
            ...
            <button onClick={onSwitchToLogin} className="text-[#EF3737] hover:underline font-bold">
              Login Here
            </button>
          </div>
        </div>
